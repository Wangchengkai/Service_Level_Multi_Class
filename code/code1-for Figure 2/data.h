...
#define Fanzhen_1_OrYouhua_0 true
...
const double tor_SeveralCustomers[NumberOfPriors + 1] = { 0,  10.0 / 60.0,  0.5,   1 };// 50.0 / 60.0 };
...
#define MaxNumberOfTranstionTimesInUniform 300#define MaxValueOfStatesInUniform 300
#define MaxValueOfStatesInIntegral MaxValueOfStatesInUniform#define MaxNumberOfTranstionTimesInIntegral MaxNumberOfTranstionTimesInUniform#define BreakThreshold 1.0e-9#define EPSILON 1.0e-5
#define MaxNumOfK 500#define MaxNumOfState  MaxValueOfStatesInUniform#define MaxNumOfPeriod NumberOfPeriodsCondsidered
